...
void UART1_Init(){
  ...
  SYSCTL_RCGC2_R			|= 0x02;																		// activate Port B clk
	...
	UART1_IBRD_R				 = IBRD_9600;															  // IBRD = int( 50MHz/ (16 * 57600)) = int(54.253472)
	UART1_FBRD_R				 = FBRD_9600;															  // FBRD = int(0.253472 * 64 + 0.5) = 54
	UART1_LCRH_R				 = 0x70;																		// 8-bits, FIFO enable, 1 stop bit and odd parity 0x72
