...
// UART0 is used for debugging purposes
void UART0_Init(void){
  ...
  UART0_CTL_R		   |= 0x0301;      	// Enable RXE, TXE and UARTEN registers
	...
	// Port A
	// configure PA1 and PA0 as UART
	// enable alt funct on PA1 and PA0
	// enable digital I/O on PA1 and PA0
...
// UART1 is used to communicate 
// via HC-05 bluetooth module
// PB1(U1Tx) yellow wire
// PB0 (U1Rx) purple wire
void UART1_Init(){
  ...
  SYSCTL_RCGC2_R		|= 0x02;	// activate Port B clk
	...
	// Port B
	// Configure PB1 (U1Tx) and PB0(U1Rx) as UART
	// enable alt funct on PB1 and PB0
	// enable digital I/O on PB1 and PB0
	// disable analog functionality on PB
