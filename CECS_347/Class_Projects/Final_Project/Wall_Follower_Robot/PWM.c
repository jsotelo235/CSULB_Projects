...
void PWM0MotorR_Init(uint16_t period, uint16_t duty){
...
// duty is number of PWM clock cycles output is high  (2<=duty<=period-1)
void PWM0MotorR_Duty(uint16_t duty){
  PWM0_0_CMPA_R = duty - 1;             // 6) count value when output rises
}
...
void PWM0MotorL_Init(uint16_t period, uint16_t duty){
...
// duty is number of PWM clock cycles output is high  (2<=duty<=period-1)
void PWM0MotorL_Duty(uint16_t duty){
  PWM0_0_CMPB_R = duty - 1;             // 6) count value when output rises
}
