...
int main(void){    
	//TExaS_Init(SW_PIN_PF40,LED_PIN_PF321); // this initializes the TExaS grader lab 
  PortF_Init();        // Call initialization of port PF4 PF2
	SysTick_Init(4000000); //Reload Value
  EnableInterrupts();  // The grader uses interrupts
  while(1){
		
    if(flag % 2 == 0){              // zero means SW1 pressed
